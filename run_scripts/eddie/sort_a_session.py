...
raw_recording_paths = [get_chronologized_recording_paths(project_path, mouse, day)[session_id]]
session_names = get_session_names(raw_recording_paths)

session_sorter_path = f"{project_path}derivatives/M{mouse}/D{day}/{session_names[0]}/{sorter_name}/session_"
...
sorter_path=None, sa_path=None, report_path=None, session_names=None, session_id=None