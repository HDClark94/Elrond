...
if len(os.listdir(project_path + f"data/M{mouse}_D{day}")) > 1:
    stagein_data(mouse, day, project_path)

# Now run full pipeline on eddie
run_python_script(elrond_path + "/../../run_scripts/eddie/run_pipeline_on_data.py " + mouse + " " + day + " " + sorter_name + " " + project_path, hold_jid=)
