...
raw_recording_paths = [get_chronologized_recording_paths(project_path, mouse, day)[1]]
session_names = get_session_names(raw_recording_paths)
do_zarrs(mouse, day, sorter_name, project_path, recording_paths = raw_recording_paths, zarr_number=1, session_names=session_names)