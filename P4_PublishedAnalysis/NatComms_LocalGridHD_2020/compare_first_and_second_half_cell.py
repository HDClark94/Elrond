...
local_path_mouse = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/correlation_cell/all_mice_df.pkl'
local_path_rat = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/correlation_cell/all_rats_df.pkl'
local_path_simulated = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/correlation_cell/all_simulated_df.pkl'
path_to_data = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/correlation_cell/'
save_output_path = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/correlation_cell/'
...
def save_corr_coef_in_csv(good_grid_coef, good_grid_cells_p):
    ...
    correlation_data.to_csv(
        Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/correlation_cell/whole_cell_correlations.csv')
...
def correlation_between_first_and_second_halves_of_session(df_all_animals, animal='mouse'):
    ...
    Published_analysis.NatComms_LocalGridHD_2020.analyze_field_correlations.plot_correlation_coef_hist(df_all_animals.hd_correlation_first_vs_second_half[good_cluster & grid_cell], save_output_path + 'correlation_hd_session_' + animal + '.png', y_axis_label='Cumulative probability')
