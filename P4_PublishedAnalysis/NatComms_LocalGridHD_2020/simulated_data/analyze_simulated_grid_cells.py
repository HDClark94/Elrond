...
import PostSorting.open_field_spatial_data
import Published_analysis.NatComms_LocalGridHD_2020.grid_analysis_other_labs.firing_maps
...
def get_rate_maps(position_data, firing_data):
    position_heat_map, spatial_firing = Published_analysis.NatComms_LocalGridHD_2020.grid_analysis_other_labs.firing_maps.make_firing_field_maps(position_data, firing_data, prm)
    return position_heat_map, spatial_firing


def make_plots(position_data, spatial_firing, position_heat_map, hd_histogram, prm):
    # P3_PostProcess.make_plots.plot_spike_histogram(spatial_firing, prm)
    # P3_PostProcess.make_plots.plot_firing_rate_vs_speed(spatial_firing, position_data, prm)
    # P3_PostProcess.make_plots.plot_autocorrelograms(spatial_firing, prm)
    ...
    # P3_PostProcess.open_field_make_plots.plot_spikes_on_firing_fields(spatial_firing, prm)
    try:
