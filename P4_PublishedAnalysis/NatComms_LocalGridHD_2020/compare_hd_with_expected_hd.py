...
local_path = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/compare_hd_with_expected_hd/'
...
def get_hd_in_field_spikes(rate_map_indices, spatial_data):
    ...
    for index, bin_in_field in enumerate(rate_map_indices):
        ...
        # hd_hist = P3_PostProcess.open_field_head_direction.get_hd_histogram(hd)
...
def get_estimated_hd(field):
    ...
    # weighed_hist_sum_smooth = P3_PostProcess.open_field_head_direction.get_rolling_sum(weighed_hist_sum, window=23) / 23
...
def distributive_hypothesis_analysis_observed(field_data, animal, output_path):
    ...
    for index, field in field_data.iterrows():
        ...
        # hd_session_real_hist = P3_PostProcess.open_field_head_direction.get_hd_histogram(field.hd_in_field_session)
        ...
        # hd_spikes_real_hist = P3_PostProcess.open_field_head_direction.get_hd_histogram(field.hd_in_field_spikes)
