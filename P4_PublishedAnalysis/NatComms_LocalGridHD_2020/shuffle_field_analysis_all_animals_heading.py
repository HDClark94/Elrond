...
def analyze_data(animal, server_path, shuffle_type='occupancy', ephys_sampling=30000, video_sampling=30, pixel_ratio=440):
    ...
    shuffled_field_data_grid = Published_analysis.NatComms_LocalGridHD_2020.shuffle_field_analysis_heading.analyze_shuffled_data(fields, local_path, video_sampling, number_of_bins=20, shuffle_type='')
...
def main():
    ...
    # server_path_simulated = NatComms_LocalGridHD_2020.folder_path_settings.get_server_path_simulated() + 'ventral_narrow/'
    # analyze_data('simulated', server_path_simulated, shuffle_type='distributive_narrow')
    # server_path_simulated = NatComms_LocalGridHD_2020.folder_path_settings.get_server_path_simulated() + 'control_narrow/'
