...
local_path = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/field_histogram_shapes/'
...
def get_range_of_correlations_for_directional(field_data):
    animal = 'mouse'
    field_shuffle = pd.read_pickle(
        Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/shuffled_analysis/grid' + animal + 'fields.pkl')
