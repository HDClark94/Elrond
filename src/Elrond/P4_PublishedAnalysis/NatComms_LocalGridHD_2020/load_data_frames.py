...
import Published_analysis.NatComms_LocalGridHD_2020.analyze_hd_from_whole_session
    ...
    for recording_folder in glob.glob(server_path + '*'):
        ...
        if os.path.exists(firing_data_frame_path):
            ...
            if 'position_x' in spatial_firing:
                ...
                # spatial_firing = P3_PostProcess.open_field_grid_cells.process_grid_data(spatial_firing)
...
def load_data_frame(output_path):
    ...
    spatial_firing_data = Published_analysis.NatComms_LocalGridHD_2020.analyze_hd_from_whole_session.add_combined_id_to_df(spatial_firing_data)
