...
def main():
    spatial_firing = pd.read_pickle(
        Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_test_recording_path() + 'DataFrames/spatial_firing.pkl')
    position_data = pd.read_pickle(
        Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_test_recording_path() + 'DataFrames/position.pkl')
