...
import Published_analysis.NatComms_LocalGridHD_2020.analyze_field_correlations
import os
...
local_path_mouse = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/watson_two_test_cells/all_mice_df.pkl'
local_path_rat = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/watson_two_test_cells/all_rats_df.pkl'
local_path_simulated = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/watson_two_test_cells/all_simulated_df.pkl'
path_to_data = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/watson_two_test_cells/'
save_output_path = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/watson_two_test_cells/'
...
server_path_simulated = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_server_path_simulated()
...
def correlation_between_first_and_second_halves_of_session(df_all_animals, animal='mouse'):
    ...
    Published_analysis.NatComms_LocalGridHD_2020.analyze_field_correlations.plot_correlation_coef_hist(df_all_animals.hd_correlation_first_vs_second_half[good_cluster & watson_significant], save_output_path + 'correlation_hd_session_' + animal + '.png', y_axis_label='Number of cells')
    Published_analysis.NatComms_LocalGridHD_2020.analyze_field_correlations.plot_correlation_coef_hist(df_all_animals.hd_correlation_first_vs_second_half[good_cluster & watson_significant & grid_cell], save_output_path + 'correlation_hd_session_grid_cell_' + animal + '.png', y_axis_label='Number of cells')
...
def tag_false_positives(all_cells, animal):
    if animal == 'mouse':
        ...
        list_of_false_positives = Published_analysis.NatComms_LocalGridHD_2020.false_positives.get_list_of_false_positives(false_positives_path)
