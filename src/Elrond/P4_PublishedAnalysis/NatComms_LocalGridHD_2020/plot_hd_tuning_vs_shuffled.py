...
def tag_false_positives(spatial_firing):
    list_of_false_positives = Published_analysis.NatComms_LocalGridHD_2020.false_positives.get_list_of_false_positives(analysis_path + 'false_positives_all.txt')
