...
local_path = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_local_path() + '/compare_first_and_second_shuffled/'
...
server_path_mouse = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_server_path_mouse()
server_path_rat = Published_analysis.NatComms_LocalGridHD_2020.folder_path_settings.get_server_path_rat()
...
def tag_false_positives(spatial_firing):
    list_of_false_positives = Published_analysis.NatComms_LocalGridHD_2020.false_positives.get_list_of_false_positives(local_path + 'false_positives_all.txt')
...
def process_data(server_path, spike_sorter='/MountainSort', df_path='/DataFrames', sampling_rate_video=30, tag='mouse'):
    ...
    for iterator in range(len(grid_data)):
        try:
            ...
            # add rate map to dfs
            # shuffle
            position_heat_map_first, first_half = Published_analysis.NatComms_LocalGridHD_2020.open_field_firing_maps_processed_data.make_firing_field_maps(position_first, first_half, prm)
            spatial_firing_first = Published_analysis.NatComms_LocalGridHD_2020.shuffle_cell_analysis.shuffle_data(first_half, 20, number_of_times_to_shuffle=1000, animal=tag + '_first_half', shuffle_type='distributive')
            spatial_firing_first = Published_analysis.NatComms_LocalGridHD_2020.shuffle_cell_analysis.add_mean_and_std_to_df(spatial_firing_first, sampling_rate_video, number_of_bins=20)
            spatial_firing_first = Published_analysis.NatComms_LocalGridHD_2020.shuffle_cell_analysis.analyze_shuffled_data(spatial_firing_first, local_path, sampling_rate_video, tag + str(iterator) + 'first',
                                                                                                                            number_of_bins=20, shuffle_type='distributive')

            # NatComms_LocalGridHD_2020.shuffle_cell_analysis.plot_distributions_for_shuffled_vs_real_cells(spatial_firing_first, 'grid', animal=tag + str(iterator) + 'first', shuffle_type='distributive')

            position_heat_map_second, second_half = Published_analysis.NatComms_LocalGridHD_2020.open_field_firing_maps_processed_data.make_firing_field_maps(position_second, second_half, prm)
            spatial_firing_second = Published_analysis.NatComms_LocalGridHD_2020.shuffle_cell_analysis.shuffle_data(second_half, 20, number_of_times_to_shuffle=1000, animal=tag + '_second_half', shuffle_type='distributive')
            spatial_firing_second = Published_analysis.NatComms_LocalGridHD_2020.shuffle_cell_analysis.add_mean_and_std_to_df(spatial_firing_second, sampling_rate_video, number_of_bins=20)
            spatial_firing_second = Published_analysis.NatComms_LocalGridHD_2020.shuffle_cell_analysis.analyze_shuffled_data(spatial_firing_second, local_path, sampling_rate_video, tag + str(iterator) + 'second',
                                                                                                                             number_of_bins=20, shuffle_type='distributive')
            # NatComms_LocalGridHD_2020.shuffle_cell_analysis.plot_distributions_for_shuffled_vs_real_cells(spatial_firing_second, 'grid', animal=tag + str(iterator) + 'second', shuffle_type='distributive')
