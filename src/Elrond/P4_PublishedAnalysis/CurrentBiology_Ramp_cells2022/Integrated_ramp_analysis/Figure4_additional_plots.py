...
import Published_analysis.CurrentBiology_Ramp_cells2022.Integrated_ramp_analysis.Python_PostSorting.Plot_Behaviour
import warnings
...
def make_behavioural_df(all_mice, take_head=True):
    ...
    for session_id in session_ids:
        ...
        session_df = Published_analysis.CurrentBiology_Ramp_cells2022.Integrated_ramp_analysis.Python_PostSorting.Plot_Behaviour.curate_stops(session_df)
        session_df = Published_analysis.CurrentBiology_Ramp_cells2022.Integrated_ramp_analysis.Python_PostSorting.Plot_Behaviour.calculate_average_stops(session_df)
        session_df = Published_analysis.CurrentBiology_Ramp_cells2022.Integrated_ramp_analysis.Python_PostSorting.Plot_Behaviour.calculate_average_nonbeaconed_stops(session_df)
