import Published_analysis.CurrentBiology_Ramp_cells2022.Integrated_ramp_analysis.Python_PostSorting.Calculate_SpikeHalfWidth
...
def main():
    ...
    spike_data = Published_analysis.CurrentBiology_Ramp_cells2022.Integrated_ramp_analysis.Python_PostSorting.Calculate_SpikeHalfWidth.calculate_spike_width(spike_data, prm)
